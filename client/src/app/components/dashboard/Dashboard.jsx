        ...
        <div className="row proBanner">
          <div className="col-12">
            <span className="d-flex align-items-center purchase-popup">
              <p>Qualquer feedback sobre como podemos montar o aplicativo é bem-vindo.</p>
              <a href="/home" rel="noopener noreferrer" className="btn ml-auto download-button">Voltar para o Site</a>
              <a href="/tables/basic-table" rel="noopener noreferrer" target="_blank" className="btn purchase-button">Ver as Tabelas</a>
